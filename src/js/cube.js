...
function MoveCubes() {
  ...
  useEffect(() => {
    ...
    function animate() {
        ...
        document.getElementById("cube-container").appendChild(container);
        ...
        for ( let i = 0; i < 1; i ++ ) {
            ...
            const object = new THREE.Mesh( geometry, new THREE.MeshLambertMaterial( { color: 0xbd22e9 } ) );
